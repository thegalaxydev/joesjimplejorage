...
public class ModBlockEntities {
	public static final BlockEntityType<InventoryConnectorEntity> INVENTORY_CONNECTOR_ENTITY = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE,new ResourceLocation(JoesJimpleJorage.MOD_ID, "inventory_connector_entity"),
